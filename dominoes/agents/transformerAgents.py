...
class transformerAgent(valueAgent):
    ...
    def prepareNetwork(self):
        ...
        self.finalScoreNetwork = dnn.handRepresentationNetwork(self.numPlayers, 
                                                               self.numDominoes, 
                                                               self.highestDominoe, 
        ...
        self.finalScoreEligibility = [[torch.zeros(prms.shape).to(self.device) for prms in self.finalScoreNetwork.parameters()] 
                                      for _ in range(self.finalScoreOutputDimension)]
